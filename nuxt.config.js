...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '「間違いを気にしない」ニース・情報ソースの共有・検証サイトのゲソンタクルです' },
      ...
      { hid: 'og:description', property: 'og:description', content: '「間違いを気にしない」ニース・情報ソースの共有・検証サイトのゲソンタクルです' },
