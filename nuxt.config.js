...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '「間違いを気にしない」ニュース・情報ソースの共有・検証サイトのゲソンタクルです' },
      ...
      { hid: 'og:description', property: 'og:description', content: '「間違いを気にしない」ニュース・情報ソースの共有・検証サイトのゲソンタクルです' },
      { hid: 'og:image', property: 'og:image', content: 'https://gesontacle.com/icon.jpg' },
